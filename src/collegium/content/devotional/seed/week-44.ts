...
/**
 * Week 44 — Mentorship (Tirocinium).
 *
 * Tirocinium: the recruit's first season, the apprentice's training year.
 * The week sits with the formation of the next generation — the old man's
 * hand on the young man's shoulder, the double portion asked for, the iron
 * that sharpens iron, the seventy-two sent two-by-two. Where last week
 * read the young lawyer, this week reads the one already older who must
 * make another.
 */
export const week44: DevotionalDay[] = [
  {
    day: 302,
    date: "10-29",
    weekNumber: 44,
    weekArc: "Mentorship",
    weekArcLatin: "Tirocinium",
    title: "The Faith of a Grandmother",
    scripture: {
      reference: "2 Timothy 1:5-6 (DR)",
    ...
    situationalTags: ["first-job", "swearing-in"],
  },
  {
    day: 303,
    date: "10-30",
    ...
    weekArc: "Mentorship",
    weekArcLatin: "Tirocinium",
    title: "Commit Thou to Faithful Men",
    scripture: {
      reference: "2 Timothy 2:1-2 (DR)",
      text: `Thou therefore, my son, be strong in the grace which is in Christ Jesus: and the things which thou hast heard of me by many witnesses, the same commend to faithful men, who shall be fit to teach others also.`,
    },
    excerpt: {
    ...
    situationalTags: ["partnership-offered", "bar-committee"],
  },
  {
    day: 304,
    date: "10-31",
    ...
    situationalTags: ["death-of-mentor", "retirement"],
  },
  {
    day: 305,
    date: "11-01",
    ...
    situationalTags: ["young-associate-mistake", "gratitude-for-the-bar"],
  },
  {
    day: 306,
    date: "11-02",
    ...
    weekArc: "Mentorship",
    weekArcLatin: "Tirocinium",
    title: "I Am as Your Father",
    scripture: {
      reference: "1 Corinthians 4:14-17 (DR)",
      text: `I write not these things to confound you; but I admonish you as my dearest children. For if you have ten thousand instructors in Christ, yet not many fathers. For in Christ Jesus, by the gospel, I have begotten you. Wherefore I beseech you, be ye followers of me, as I also am of Christ. For this cause I have sent to you Timothy, who is my dearest son and faithful in the Lord; who will put you in mind of my ways, which are in Christ Jesus: as I teach every where in every church.`,
    },
    excerpt: {
      workId: "newman-idea",
    ...
    situationalTags: ["first-job", "forgetting-why-you-do-this"],
  },
  {
    day: 307,
    date: "11-03",
    ...
    weekArc: "Mentorship",
    weekArcLatin: "Tirocinium",
    title: "My Son, If Thou Come to Serve",
    scripture: {
      reference: "Ecclesiasticus 2:1-6 (DR)",
    ...
    situationalTags: ["accepting-pro-bono", "billable-hour-burnout"],
  },
  {
    day: 308,
    date: "11-04",
    ...
    weekArc: "Mentorship",
    weekArcLatin: "Tirocinium",
    title: "The Seventy-Two Sent",
    scripture: {
      reference: "Luke 10:1-9 (DR)",
      text: `And after these things the Lord appointed also other seventy-two: and he sent them two and two before his face into every city and place whither he himself was to come. And he said to them: The harvest indeed is great, but the labourers are few. Pray ye therefore the Lord of the harvest, that he send labourers into his harvest. Go: Behold I send you as lambs among wolves. Carry neither purse, nor scrip, nor shoes; and salute no man by the way. Into whatsoever house you enter, first say: Peace be to this house. And if the son of peace be there, your peace shall rest upon him; but if not, it shall return to you. And in the same house, remain, eating and drinking such things as they have: for the labourer is worthy of his hire. Remove not from house to house. And into what city soever you enter, and they receive you, eat such things as are set before you. And heal the sick that are therein, and say to them: The kingdom of God is come nigh unto you.`,
    },
    excerpt: {
      workId: "augustine-city",
      author: "St. Augustine of Hippo",
    ...
    situationalTags: ["accepting-pro-bono", "justice-gap", "bar-committee"],
  },
];

...
/**
 * Week 39 — Gratitude (Gratitudo).
 *
 * Three-quarters of a year now traveled. The discipline of the grateful
 * advocate: gratitude not as a sentiment that visits, but as a virtue
 * that is built — by saying the words, returning to give thanks, blessing
 * the Giver while the gift is still in the hand.
 */
export const week39: DevotionalDay[] = [
  {
    day: 267,
    date: "09-24",
    weekNumber: 39,
    weekArc: "Gratitude",
    weekArcLatin: "Gratitudo",
    title: "Give Thanks, For He Is Good",
    scripture: {
      reference: "Psalm 135:1-4 (DR)",
      text: `Praise the Lord, for he is good: for his mercy endureth for ever. Praise ye the God of gods: for his mercy endureth for ever. Praise ye the Lord of lords: for his mercy endureth for ever. Who alone doth great wonders: for his mercy endureth for ever.`,
    },
    excerpt: {
  ...
  },
  {
    ...
    scripture: {
      reference: "1 Thessalonians 5:16-18 (DR)",
    ...
    situationalTags: ["after-loss", "billable-hour-burnout"],
  },
  {
    day: 269,
    date: "09-26",
    ...
    weekArc: "Gratitude",
    weekArcLatin: "Gratitudo",
    title: "Only One Returned",
    scripture: {
      reference: "Luke 17:11-19 (DR)",
    ...
    situationalTags: ["after-win", "forgetting-why-you-do-this"],
  },
  {
    day: 270,
    date: "09-27",
  ...
  },
  {
    ...
    weekArc: "Gratitude",
    weekArcLatin: "Gratitudo",
    title: "And Be Ye Thankful",
    scripture: {
      reference: "Colossians 3:15-17 (DR)",
    ...
    situationalTags: ["gratitude-for-the-bar", "before-mass"],
  },
  {
    day: 272,
    date: "09-29",
    ...
    weekArc: "Gratitude",
    weekArcLatin: "Gratitudo",
    title: "Daniel Blesses God for Wisdom",
    scripture: {
      reference: "Daniel 2:20-23 (DR)",
      text: `And speaking, he said: Blessed be the name of the Lord from eternity and for evermore: for wisdom and fortitude are his. And he changeth times and ages: taketh away kingdoms and establisheth them: giveth wisdom to the wise, and knowledge to them that have understanding. He revealeth deep and hidden things, and knoweth what is in darkness: and light is with him. To thee, O God of our fathers, I give thanks, and I praise thee: because thou hast given me wisdom and strength: and now thou hast shewn me what we desired of thee, for thou hast made known to us the king's matter.`,
    },
    excerpt: {
      workId: "aquinas-summa",
      author: "St. Thomas Aquinas",
    ...
    situationalTags: ["after-win", "gratitude-for-the-bar"],
  },
  {
    day: 273,
    date: "09-30",
    ...
    scripture: {
      reference: "Psalm 115:12-14 (DR)",
      text: `What shall I render to the Lord, for all the things that he hath rendered to me? I will take the chalice of salvation; and I will call upon the name of the Lord. I will pay my vows to the Lord before all his people: precious in the sight of the Lord is the death of his saints.`,
    },
    excerpt: {
    ...
    situationalTags: ["death-of-mentor", "after-confession"],
  },
];

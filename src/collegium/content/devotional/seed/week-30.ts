...
/**
 * Week 30 — Place (Statio).
 *
 * The physical office, the desk, the chair, the windowsill — the place
 * where the work is done. The week looks at vocation under the rafters
 * of a particular room: the holy ground of the daily station, the
 * temple of the practitioner's own body, the dwelling that is not made
 * with hands. Statio in the monastic sense: the place you keep, the
 * post you do not abandon, the ground from which the work is offered.
 */
export const week30: DevotionalDay[] = [
  {
    day: 204,
    date: "07-23",
    weekNumber: 30,
    weekArc: "Place",
    weekArcLatin: "Statio",
    title: "The Lord Is in This Place",
    scripture: {
      reference: "Genesis 28:16-17 (DR)",
      text: `And when Jacob awaked out of sleep, he said: Indeed the Lord is in this place, and I knew it not. And trembling he said: How terrible is this place! this is no other but the house of God, and the gate of heaven.`,
    },
    excerpt: {
    ...
    situationalTags: ["11pm-still-at-office", "forgetting-why-you-do-this"],
  },
  {
    day: 205,
    date: "07-24",
    ...
    scripture: {
      reference: "1 Corinthians 3:16-17 (DR)",
      text: `Know you not, that you are the temple of God, and that the Spirit of God dwelleth in you? But if any man violate the temple of God, him shall God destroy. For the temple of God is holy, which you are.`,
    },
    excerpt: {
    ...
    situationalTags: ["forgetting-why-you-do-this", "billable-hour-burnout"],
  },
  {
    day: 206,
    date: "07-25",
    ...
    weekArc: "Place",
    weekArcLatin: "Statio",
    title: "To Dwell in the House of the Lord",
    scripture: {
      reference: "Psalm 26:4 (DR) [27:4 Hebrew]",
      text: `One thing I have asked of the Lord, this will I seek after; that I may dwell in the house of the Lord all the days of my life. That I may see the delight of the Lord, and may visit his temple.`,
    },
    excerpt: {
      workId: "newman-idea",
    ...
    situationalTags: ["before-mass", "sole-practice-loneliness"],
  },
  {
    day: 207,
    date: "07-26",
    ...
    situationalTags: ["swearing-in", "on-the-feast-day"],
  },
  {
    day: 208,
    date: "07-27",
    ...
    weekArc: "Place",
    weekArcLatin: "Statio",
    title: "Not in Temples Made With Hands",
    scripture: {
      reference: "Acts 17:24-28 (DR)",
    ...
    situationalTags: ["forgetting-why-you-do-this", "weekend-document-review"],
  },
  {
    day: 209,
    date: "07-28",
    ...
    situationalTags: ["pride-in-the-win", "after-win"],
  },
  {
    day: 210,
    date: "07-29",
    ...
    situationalTags: ["forgetting-why-you-do-this", "retirement"],
  },
];

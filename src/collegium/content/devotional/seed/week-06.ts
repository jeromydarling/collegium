...
/**
 * Week 6 — Authority (Auctoritas).
 *
 * What legitimates a command? When obedience is virtue and when it is
 * complicity. The week sits with Aquinas on law, Augustine on kingdoms
 * without justice, Peter before the Sanhedrin, and the long Christian
 * tradition of conscientious refusal.
 */
export const week06: DevotionalDay[] = [
  {
    day: 36,
    date: "02-05",
    weekNumber: 6,
    weekArc: "Authority",
    weekArcLatin: "Auctoritas",
    title: "The Four Marks of a Law",
    scripture: {
      reference: "Romans 13:1–4",
      text: `Let every soul be subject to higher powers: for there is no power but from God: and those that are, are ordained of God. Therefore he that resisteth the power, resisteth the ordinance of God. And they that resist, purchase to themselves damnation. For princes are not a terror to the good work, but to the evil. Wilt thou then not be afraid of the power? Do that which is good: and thou shalt have praise from the same. For he is God's minister to thee, for good. But if thou do that which is evil, fear: for he beareth not the sword in vain. For he is God's minister: an avenger to execute wrath upon him that doth evil.`,
    },
    excerpt: {
      workId: "aquinas-summa",
      author: "Thomas Aquinas",
      citation: "Summa Theologiae I-II, q.90, a.4 (trans. Fathers of the English Dominican Province, 1920)",
      text: `Thus from the four preceding articles, the definition of law may be gathered; and it is nothing else than an ordinance of reason for the common good, made by him who has care of the community, and promulgated.`,
    },
  },
  {
    day: 37,
  ...
  },
  {
    ...
    weekArc: "Authority",
    weekArcLatin: "Auctoritas",
    title: "Romans 13 and Its Limits",
    scripture: {
      reference: "Romans 13:5–7",
      text: `Wherefore be subject of necessity, not only for wrath, but also for conscience' sake. For therefore also you pay tribute. For they are the ministers of God, serving unto this purpose. Render therefore to all men their dues. Tribute, to whom tribute is due: custom, to whom custom: fear, to whom fear: honour, to whom honour.`,
    },
    excerpt: {
      workId: "augustine-city",
      author: "Augustine of Hippo",
      citation: "City of God XIX.21 (trans. Marcus Dods, 1871)",
      text: `Where, then, is the justice of man, when it deserts the true God and yields itself to impure demons? Is this to give every man his due? Or is he unjust who takes away a field from the man who has bought it, and gives it to one who has no right to it; and just who takes himself away from the Lord God who made him, and serves wicked spirits?`,
    },
  },
  {
    day: 39,
  ...
  },
  {
    ...
    excerpt: {
      workId: "augustine-city",
      author: "Augustine of Hippo",
      citation: "City of God IV.4 (trans. Marcus Dods, 1871)",

    ...
    <div className="collegium-theme">
      <section className="collegium-illuminated border-b border-[hsl(var(--c-border))]">
        <div className="max-w-3xl mx-auto px-5 py-20">
          ...
          <h1 className="collegium-display-xl text-5xl mb-6">About Collegium</h1>
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-5 py-20 collegium-prose">
          <h2 className="collegium-display text-3xl">Who we are</h2>
          <p>
          ...
          <h2 className="collegium-display text-3xl">Why now</h2>
          <p>
          ...
          <h2 className="collegium-display text-3xl">Our voice</h2>
          <p>
          ...
          <h2 className="collegium-display text-3xl">Build status</h2>
          <p>
